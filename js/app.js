...
colorSwitcher.addEventListener("click", () => {
  ...
  const currentTheme = document.documentElement.style.getPropertyValue(
    "--base--light"
  )
    ? "light"
    : "dark";
  ...
  if (currentTheme === "light") {
    document.documentElement.style.setProperty("--base--light", "#1E1E1E");
    document.documentElement.style.setProperty("--neutral-bright", "#ffffff");
    // Add any other properties you need to switch
  } else {
    document.documentElement.style.setProperty("--base--light", "#F5F5F5");
    document.documentElement.style.setProperty("--neutral-bright", "#000000");
